...
import benefitImage from "../../assets/logos/Benefit.png";
import feedbackImage from "../../assets/logos/feedback.png";
import awardImage from "../../assets/logos/Award2.png";
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-3 2xl:gap-7">
          {pathways.map(({ id, title, eyebrow, description, image, href, icon: Icon, accent, stats }) => (
            <Link
              ...
              id={id}
              to={href}
              className="ecosystem-path-card group relative flex min-h-[31rem] overflow-hidden rounded-[1.7rem] border border-emerald-200/14 bg-white/[0.06] shadow-[0_28px_90px_-60px_rgba(34,197,94,0.85)] backdrop-blur-2xl transition duration-300 hover:-translate-y-1 hover:border-emerald-200/28 hover:bg-white/[0.09]"
            >
              ...
              <div className="relative z-10 flex w-full flex-col justify-between p-5 sm:p-6">
                ...
                <div className="mt-8">
                  ...
                  <span className="mt-5 inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-2xl border border-emerald-200/20 bg-emerald-300 px-5 text-sm font-black text-slate-950 shadow-[0_18px_50px_-32px_rgba(52,211,153,0.9)] transition group-hover:bg-cyan-200">
                    Open {title}
